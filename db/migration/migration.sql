...
create index if not exists transfers_from_account_id_to_account_id_idx
...
create table if not exists trd_ref_date
(
...
create table if not exists trd_trade
(
...
create table if not exists trd_external_ref
(
    trd_recordno       integer not null,
...
create table if not exists trd_driver
(
    trd_recordno   integer not null,
...
create table if not exists trd_instrument
(
    trd_recordno      integer not null,
...
create table if not exists trd_journal
(
    trd_recordno         integer not null,
...
create table if not exists trd_link
(
    trd_recordno           integer not null,
...
create table if not exists trd_inst_ext
(
    trd_recordno integer not null,
...
create table if not exists trd_trade_narrative
(
    trd_recordno       integer not null,
...
create table if not exists trd_party
(
    trd_recordno           integer not null,
...
create table if not exists trd_party_driver
(
    trd_recordno    integer not null,
    trd_trade_party text    not null,
...
create table if not exists trd_rate
(
    trd_recordno           integer not null,
...
create table if not exists trd_amount
(
    trd_recordno              integer not null,
...
create table if not exists trd_settlement
(
    trd_recordno         integer not null,
...
create table if not exists trd_processing
(
    trd_recordno      integer not null,
...
create table if not exists trd_processing_event
(
    trd_recordno      integer not null,
...
create table if not exists trd_event_narrative
(
    trd_recordno       integer not null,
    trd_narrative_code text    not null,
    trd_seqno          text    not null,
...
create table if not exists trd_instruction
(
    trd_recordno         integer not null,
    trd_procaction       text    not null,
...
create table if not exists trd_instruction_effect
(
    trd_recordno      integer not null,
    trd_eventtype     text    not null,
    trd_eventdate     text    not null,
...
create table if not exists trd_event
(
    trd_recordno      integer not null,
    trd_eventtype     text    not null,
    trd_eventdate     text    not null,
...
create table if not exists trd_trade_code
(
    trd_recordno  integer not null,
...
create table if not exists instr_instruments
(
...
create table if not exists pty_party
(
