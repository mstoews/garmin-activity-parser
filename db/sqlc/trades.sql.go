...
func (q *Queries) ListTradeInstructionEffect(ctx context.Context, trdRecordno int32) ([]TrdInstructionEffect, error) {
	...
	defer rows.Close()
	var items []TrdInstructionEffect
	for rows.Next() {
		var i TrdInstructionEffect
		if err := rows.Scan(
			&i.TrdRecordno,
